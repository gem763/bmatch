# Generated by Django 2.2.2 on 2019-10-01 09:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(limit_choices_to=models.Q(models.Q(('app_label', 'app'), ('model', 'brand')), models.Q(('app_label', 'app'), ('model', 'customchannel')), _connector='OR'), on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
            ],
        ),
        migrations.CreateModel(
            name='Customchannel',
            fields=[
                ...
                ('keywords', models.TextField(blank=True, max_length=500, null=True)),
                ('description', models.TextField(blank=True, max_length=500, null=True)),
                ('image', models.ImageField(default='', upload_to='customchannel_images')),
            ],
        ),
        migrations.CreateModel(
            name='Hashtag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channels', models.ManyToManyField(blank=True, to='app.Channel')),
