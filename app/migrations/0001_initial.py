# Generated by Django 2.2.2 on 2019-07-30 16:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keywords', models.TextField(blank=True, max_length=500, null=True)),
                ('description', models.TextField(blank=True, max_length=500, null=True)),
                ('image', models.ImageField(default='', upload_to='custompage_images')),
            ],
        ),
        migrations.CreateModel(
            name='Hashtag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(limit_choices_to=models.Q(models.Q(('app_label', 'app'), ('model', 'brand')), models.Q(('app_label', 'app'), ('model', 'custompage')), _connector='OR'), on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType')),
                ('master', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.Profile')),
            ],
        ),
        migrations.CreateModel(
            name='Feed',
            fields=[
                ...
                ('image', models.ImageField(upload_to=app.models.feed_image_path)),
                ...
                ('pages', models.ManyToManyField(blank=True, to='app.Page')),
            ],
            options={
                'abstract': False,
            },
